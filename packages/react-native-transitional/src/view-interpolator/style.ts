import { ColorValue, Animated, ViewStyle } from "react-native"
...
export const styleInterpolator = {
    ...
    [key in NonNullable<keyof Animated.AnimatedProps<ViewStyle>>]: (
        prev?: ViewStyle[key],
        next?: ViewStyle[key],
        ratio?: number
    ) => ViewStyle[key]
...
export const animatedStyleMappeer = {
    ...
    [key in NonNullable<keyof Animated.AnimatedProps<ViewStyle>>]: (
        ...
        next?: ViewStyle[key],
        animatedValue?: Animated.Value
    ) => Animated.WithAnimatedValue<ViewStyle[key]> | ViewStyle[key]
}