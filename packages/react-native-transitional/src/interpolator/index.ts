...
import { keysOf, makeRecords, viewStyleProperties, textStyleProperties, imageStyleProperties } from "@monthem/utils"
...
export const viewStyleInterpolator = new TransitionalInterpolator<ViewStyle>({
  ...
  properties: viewStyleProperties
})
...
export const imageStyleInterpolator = new TransitionalInterpolator<ImageStyle>({
  ...
  properties: imageStyleProperties
})
