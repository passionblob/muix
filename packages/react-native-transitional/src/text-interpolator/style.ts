import { ColorValue, Animated, TextStyle } from "react-native"
...
export const styleInterpolator = {
    ...
    [key in NonNullable<keyof Animated.AnimatedProps<TextStyle>>]: (
        prev?: TextStyle[key],
        next?: TextStyle[key],
        ratio?: number
    ) => TextStyle[key]
...
export const animatedStyleMappeer = {
    ...
    [key in NonNullable<keyof Animated.AnimatedProps<TextStyle>>]: (
        ...
        next?: TextStyle[key],
        animatedValue?: Animated.Value
    ) => Animated.WithAnimatedValue<TextStyle[key]> | TextStyle[key]
}