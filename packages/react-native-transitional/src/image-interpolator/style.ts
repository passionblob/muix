import { ColorValue, Animated, ImageStyle } from "react-native"
...
export const styleInterpolator = {
    ...
    [key in NonNullable<keyof Animated.AnimatedProps<ImageStyle>>]: (
        prev?: ImageStyle[key],
        next?: ImageStyle[key],
        ratio?: number
    ) => ImageStyle[key]
...
export const animatedStyleMappeer = {
    ...
    [key in NonNullable<keyof Animated.AnimatedProps<ImageStyle>>]: (
        ...
        next?: ImageStyle[key],
        animatedValue?: Animated.Value
    ) => Animated.WithAnimatedValue<ImageStyle[key]> | ImageStyle[key]
}